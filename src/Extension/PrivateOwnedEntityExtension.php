...
final class PrivateOwnedEntityExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    ...
    private function filterMine(QueryBuilder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator): void
    {
        ...
        $queryBuilder->setParameter($ownerParameter, $user->getId()->toBinary());
    }
